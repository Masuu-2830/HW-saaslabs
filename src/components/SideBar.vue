      ...
      <div class="pd-b-10 pd-l-10">
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'mine'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'mine' && 'active'
                "
              >
        ...
        214.6,85.9 199.5,61 172.6,59.1 153.6,74.1 151,299 109.7,239.4 88.7,240 69.5,254.4 65.8,279.4 	"
            ...
            c-14.4,21.3-34.4,36.2-57.4,43.9c-23.1,7.7-49.3,8.2-75.9,0.8c-31.1-8.7-62.7-28.2-90.6-59.6L75.7,281.8L69.5,285.4z"
                ...
                <span>Mine</span>
                <span class="badge text-primary hw-count" id="mine-count">{{
                  mailbox.stats.mine > 0 ||
                  typeof mailbox.stats.mine === "string"
                    ? mailbox.stats.mine == 0
                      ? ""
                      : mailbox.stats.mine
                    : ""
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'mentions'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'mentions' && 'active'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="badge text-primary hw-count" id="mentions-count">{{
                  mailbox.stats.mentions > 0 ||
                  typeof mailbox.stats.mentions === "string"
                    ? mailbox.stats.mentions == 0
                      ? ""
                      : mailbox.stats.mentions
                    : ""
                }}</span>
              </span></router-link
            >
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'discussions'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'discussions' && 'active'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span
                  ...
                  >{{
                    mailbox.stats.discussions > 0 ||
                    typeof mailbox.stats.discussions === "string"
                      ? mailbox.stats.discussions == 0
                        ? ""
                        : mailbox.stats.discussions
                      : ""
                  }}</span
                >
              </span>
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'all'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'all' && 'active'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="badge text-primary hw-count" id="all-count">{{
                  mailbox.stats.inbox > 0 ||
                  typeof mailbox.stats.inbox === "string"
                    ? mailbox.stats.inbox == 0
                      ? ""
                      : mailbox.stats.inbox
                    : ""
            ...
            >
              <span
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'assigned'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'assigned' && 'active'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="badge text-primary hw-count" id="assigned-count">{{
                  mailbox.stats.assigned > 0 ||
                  typeof mailbox.stats.assigned === "string"
                    ? mailbox.stats.assigned == 0
                      ? ""
                      : mailbox.stats.assigned
                    : ""
                }}</span>
              </span>
            </router-link>
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'unassigned'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'unassigned' && 'active'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span
                  ...
                  id="unassigned-count"
                  >{{
                    mailbox.stats.unassigned > 0 ||
                    typeof mailbox.stats.unassigned === "string"
                      ? mailbox.stats.unassigned == 0
                        ? ""
                        : mailbox.stats.unassigned
                      : ""
                  }}</span
                >
              </span>
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'starred'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'starred' && 'active'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span>Starred</span>
                <span class="badge text-primary hw-count" id="starred-count">{{
                  mailbox.stats.starred > 0 ||
                  typeof mailbox.stats.starred === "string"
                    ? mailbox.stats.starred == 0
                      ? ""
                      : mailbox.stats.starred
                    : ""
                }}</span>
              </span>
            </router-link>
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'snoozed'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'snoozed' && 'active'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span>Snoozed</span>
                <span class="badge text-primary hw-count" id="snoozed-count">{{
                  mailbox.stats.snoozed > 0 ||
                  typeof mailbox.stats.snoozed === "string"
                    ? mailbox.stats.snoozed == 0
                      ? ""
                      : mailbox.stats.snoozed
                    : ""
                }}</span>
              </span>
            </router-link>
            ...
            >
              <span
                ...
                :class="
                  this.$route.params.type !== undefined
                    ? this.$route.params.type == 'drafts'
                      ? 'active'
                      : ''
                    : this.$store.state.type == 'drafts' && 'active'
                "
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                ...
                <span class="badge text-primary hw-count" id="drafts-count">{{
                  mailbox.stats.drafts > 0 ||
                  typeof mailbox.stats.drafts === "string"
                    ? mailbox.stats.drafts == 0
                      ? ""
                      : mailbox.stats.drafts
                    : ""
                }}</span>
              </span>
            </router-link>
            ...
            >
                  ...
                  :class="
                    this.$route.params.type !== undefined
                      ? this.$route.params.type == 'sent'
                        ? 'active'
                        : ''
                      : this.$store.state.type == 'sent' && 'active'
                  "
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                  ...
                  :class="
                    this.$route.params.type !== undefined
                      ? this.$route.params.type == 'scheduled'
                        ? 'active'
                        : ''
                      : this.$store.state.type == 'scheduled' && 'active'
                  "
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                  ...
                  :class="
                    this.$route.params.type !== undefined
                      ? this.$route.params.type == 'closed'
                        ? 'active'
                        : ''
                      : this.$store.state.type == 'closed' && 'active'
                  "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  :class="
                    this.$route.params.type !== undefined
                      ? this.$route.params.type == 'spam'
                        ? 'active'
                        : ''
                      : this.$store.state.type == 'spam' && 'active'
                  "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  :class="
                    this.$route.params.type !== undefined
                      ? this.$route.params.type == 'trash'
                        ? 'active'
                        : ''
                      : this.$store.state.type == 'trash' && 'active'
                  "
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
              ...
              <router-link
                ...
                :to="{
                  name: 'type',
                  params: { type: 'tag-' + tag.id, mailboxId: mailbox.id },
                }"
              >
                <a
                  @click="broad"
